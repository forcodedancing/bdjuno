...
func (suite *DbTestSuite) TestSaveConsensus_GetBlockHeightTimeMinuteAgo() {
	...
	_, err = suite.database.Sqlx.Exec(`INSERT INTO validator (consensus_address, consensus_pubkey) 
	...
	_, err = suite.database.Sqlx.Exec(`INSERT INTO block(height, hash, num_txs, total_gas, proposer_address, timestamp)
